...
<%@ Register src="Control_Alfanumerico.ascx" tagname="Control_Alfanumerico" tagprefix="uc5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 100%;">
        <tr>
            ...
            <td  colspan="2" bgcolor="#FFCC99" style="background-color: #3366FF">
                
                <asp:Label ID="Label9" runat="server" Text="Registro de Alumnos" 
                    Font-Size="Large" style="font-weight: 700; color: #FFFFFF"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style4" >
                <asp:Label ID="Label10" runat="server" Text="Registro" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3" >
        ...
        <tr>
            ...
            <td class="style4" >
               <asp:Label ID="Label1" runat="server" Text="Nombre" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3" >
        ...
        <tr>
            ...
            <td class="style4" >
                ...
                <asp:Label ID="Label2" runat="server" Text="Ap. Paterno" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3" >
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style4">
                <asp:Label ID="Label3" runat="server" Text="Ap. Materno" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3">
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style4">
                <asp:Label ID="Label4" runat="server" Text="Fecha nacimiento" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3">
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style4">
                <asp:Label ID="Label5" runat="server" Text="Direccion" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3">
                <uc5:Control_Alfanumerico ID="Control_Alfanumerico1" runat="server" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style4">
                <asp:Label ID="Label6" runat="server" Text="Telefono" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3">
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style4">
                <asp:Label ID="Label7" runat="server" Text="CI" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3">
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style4">
                <asp:Label ID="Label8" runat="server" Text="Carrera" CssClass="style8" 
                    Font-Size="Medium" style="font-weight: 700"></asp:Label>
            </td>
            <td class="style3">
